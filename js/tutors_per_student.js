...
d3.json(generate_uw_api_url('resources/tutors.json'), function(error, response) {
   ...
   d3.json(generate_uw_api_url('terms/1161/enrollment.json'), function(error, response) {
      ...
      chart = d3.select('.tutors_per_student');
